    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div> <a class="menu-item {{ Request::routeIs('admin.information.upload') ? ' here show menu-accordion' : '' }}"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ Request::routeIs('admin.translations.index', 'admin.banners.index', 'admin.faq.index', 'admin.sertificates.index', 'admin.partners.index', 'admin.galleries.index') ? ' here show menu-accordion' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
